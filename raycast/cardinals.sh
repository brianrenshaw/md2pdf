...
# Documentation:
# @raycast.description Convert selected Markdown file(s) to Cardinals-branded PDF
...
"$NODE_PATH" "$SCRIPT_DIR/md2pdf.mjs" "cardinals" "$TARGET"
EXIT_CODE=$?
