...
# Documentation:
# @raycast.description Convert selected Markdown file(s) to modern dark mode PDF
...
"$NODE_PATH" "$SCRIPT_DIR/md2pdf.mjs" "noir-plus" "$TARGET"
EXIT_CODE=$?
