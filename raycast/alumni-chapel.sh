...
# @raycast.title Alumni Chapel PDF
...
# Documentation:
# @raycast.description Convert selected Markdown file(s) to Alumni Chapel branded PDF
# @raycast.author Brian Renshaw

SCRIPT_DIR="$(cd "$(dirname "$0")/.." && pwd)"
CONFIG="$SCRIPT_DIR/config.json"

# Read node path and output dir from config
