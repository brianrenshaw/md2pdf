...
# Documentation:
# @raycast.description Convert selected Markdown file(s) to Anthropic-styled PDF
...
"$NODE_PATH" "$SCRIPT_DIR/md2pdf.mjs" "anthropic" "$TARGET"
EXIT_CODE=$?
